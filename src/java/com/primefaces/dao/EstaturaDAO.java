...
public class EstaturaDAO implements IOperaciones<Estatura, Long> {
    ...
    private static final String SQL_SELECT_BY_ID = "SELECT jugador_id, fecha, estatura\n"
            + "	FROM public.estatura WHERE jugador_id = ?";
    ...
    public int insertar(Estatura estatura) {
        ...
        if (conn != null) {
            ...
            try {
                ...
                stmt.setBigDecimal(3, estatura.getEstatura());
        ...
        if (conexion != null) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    estatura.setEstatura(rs.getBigDecimal(3));
    ...
    public List<Estatura> obtenerTodosById(long id) {
        Conexion conexion = new Conexion();
        Connection conn = conexion.getConnection();//Realiza la conexion
        List<Estatura> estaturas = new ArrayList<>();
