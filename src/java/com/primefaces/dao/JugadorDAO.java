    ...
    public int modificar(Jugador jugador) {
        ...
        if (conn != null) {
            ...
            try {
                ...
                stmt.setString(1, jugador.getPosicion().toString());
        ...
        if (conexion != null) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    ContactoEmergencia contactoEmergencia = contactoEmergenciaDAO.obtener(Long.parseLong(rs.getString(2)));
                    String posicion = rs.getString(3);

                    //Creamos obj de la entidad correspondiente 
                    Jugador jugador = new Jugador(id, contactoEmergencia, posicion);
                    return jugador;
